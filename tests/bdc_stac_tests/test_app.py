...
class TestBDCStac:
    ...
    def test_collection(self, client):
        response = client.get("/collections/LC8SR")
        data = response.get_json()
    ...
    def test_collection_items(self, client):
        response = client.get("/collections/LC8SR/items?limit=1")
        data = response.get_json()
    ...
    def test_collection_items_id(self, client):
        response = client.get("/collections/LC8SR/items/LC8SR-LC08_L1TP_221069_20190103_20190130_01_T1")
        data = response.get_json()
    ...
    def test_collection_items_id_error(self, client):
        response = client.get("/collections/LC8SR/items/wrong_item")
        assert response.status_code == 404

    def test_stac_search(self, client):
        response = client.get("/stac/search")
        assert response.status_code == 200
        ...
        response = client.post("/stac/search", content_type="application/json", json=dict())
    ...
    def test_stac_search_wrong_content_type(self, client):
        response = client.post("/stac/search", content_type="text/plain", json=dict())
    ...
    def test_stac_search_parameters(self, client):
        ...
        response = client.post("/stac/search", content_type="application/json", json=parameters)
    ...
    def test_stac_search_parameters_ids(self, client):
        parameters = {"ids": ["LC8SR-LC08_L1TP_221069_20190103_20190130_01_T1"]}
